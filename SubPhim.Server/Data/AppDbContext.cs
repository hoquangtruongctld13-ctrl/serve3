...
namespace SubPhim.Server.Data
{
    public class AppDbContext : DbContext
    {
        ...
        // Vbee TTS DbSets
        public DbSet<VbeeVoice> VbeeVoices { get; set; }
        public DbSet<VbeeTtsSetting> VbeeTtsSettings { get; set; }
        public DbSet<VbeeTtsSession> VbeeTtsSessions { get; set; }
        public DbSet<VbeeFakeEndpoint> VbeeFakeEndpoints { get; set; }
        ...
        LastUpdated = new DateTime(2025, 1, 1, 0, 0, 0, DateTimeKind.Utc)
            ...
            modelBuilder.Entity<SubtitleApiSetting>()
                .HasData(new SubtitleApiSetting
                {
                    ...
                    Temperature = 0.3m,
                    ThinkingBudget = 0,
                    RpmPeriodSeconds = 60, // Mặc định 60 giây = 1 phút
                    UpdatedAt = new DateTime(2025, 1, 1, 0, 0, 0, DateTimeKind.Utc)
                });
        }
    }
