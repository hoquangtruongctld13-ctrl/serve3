...
builder.Services.AddSingleton<ProxyStatsQueueService>(); // Background service cho fire-and-forget proxy stats
builder.Services.AddHostedService(sp => sp.GetRequiredService<ProxyStatsQueueService>()); // Register as hosted service
builder.Services.AddSingleton<ProxyService>(); // Singleton để quản lý và luân phiên proxy
builder.Services.AddSingleton<ProxyHealthCheckService>(); // Singleton để kiểm tra sức khỏe proxy
...
builder.Services.AddDbContext<AppDbContext>(options =>
{
    ...
    // Suppress PendingModelChangesWarning since we handle schema changes manually in EnsureMissingColumnsExist
...
static void EnsureMissingColumnsExist(AppDbContext context, ILogger logger)
{
    ...
    try
    {
        ...
        var tablesToCreate = new List<(string TableName, string CreateStatement)>
        {
            ...
            // === VBEE TTS TABLES ===
            ("VbeeVoices", @"
                CREATE TABLE IF NOT EXISTS ""VbeeVoices"" (
                    ""Id"" INTEGER NOT NULL CONSTRAINT ""PK_VbeeVoices"" PRIMARY KEY AUTOINCREMENT,
                    ...
                    ""CreatedAt"" TEXT NOT NULL DEFAULT '2025-01-01 00:00:00'
                );"),
            ("VbeeTtsSettings", @"
                CREATE TABLE IF NOT EXISTS ""VbeeTtsSettings"" (
                    ""Id"" INTEGER NOT NULL CONSTRAINT ""PK_VbeeTtsSettings"" PRIMARY KEY,
                    ""EncryptedApiUrl"" TEXT NOT NULL,
                    ""ApiUrlIv"" TEXT NOT NULL,
                    ""SynthesizeEndpoint"" TEXT NOT NULL DEFAULT '/synthesize',
                    ""RequestTimeoutSeconds"" INTEGER NOT NULL DEFAULT 60,
                    ""MaxRetries"" INTEGER NOT NULL DEFAULT 3,
                    ""RetryDelayMs"" INTEGER NOT NULL DEFAULT 2000,
                    ""MaxChunkSize"" INTEGER NOT NULL DEFAULT 1000,
                    ""PausePeriod"" TEXT NOT NULL DEFAULT '0.35',
                    ""PauseComma"" TEXT NOT NULL DEFAULT '0.025',
                    ""PauseSemicolon"" TEXT NOT NULL DEFAULT '0.3',
                    ""PauseNewline"" TEXT NOT NULL DEFAULT '0.6',
                    ""UpdatedAt"" TEXT NOT NULL DEFAULT '2025-01-01 00:00:00'
                );"),
            ("VbeeTtsSessions", @"
                CREATE TABLE IF NOT EXISTS ""VbeeTtsSessions"" (
                    ""SessionId"" TEXT NOT NULL CONSTRAINT ""PK_VbeeTtsSessions"" PRIMARY KEY,
                    ""UserId"" INTEGER NOT NULL,
                    ""VoiceCode"" TEXT NULL,
                    ""TotalCharactersRequested"" INTEGER NOT NULL DEFAULT 0,
                    ""CharactersProcessed"" INTEGER NOT NULL DEFAULT 0,
                    ""CharactersCharged"" INTEGER NOT NULL DEFAULT 0,
                    ""Status"" INTEGER NOT NULL DEFAULT 0,
                    ""ErrorMessage"" TEXT NULL,
                    ""ObfuscationToken"" TEXT NULL,
                    ""EncryptedBackupData"" TEXT NULL,
                    ""CreatedAt"" TEXT NOT NULL DEFAULT '2025-01-01 00:00:00',
                    ""CompletedAt"" TEXT NULL,
                    ""LastHeartbeatAt"" TEXT NOT NULL DEFAULT '2025-01-01 00:00:00',
                    FOREIGN KEY (""UserId"") REFERENCES ""Users"" (""Id"") ON DELETE CASCADE
                );"),
            ("VbeeFakeEndpoints", @"
                CREATE TABLE IF NOT EXISTS ""VbeeFakeEndpoints"" (
                    ""Id"" INTEGER NOT NULL CONSTRAINT ""PK_VbeeFakeEndpoints"" PRIMARY KEY AUTOINCREMENT,
                    ""FakePath"" TEXT NOT NULL,
                    ""Purpose"" TEXT NOT NULL,
                    ""ResponseDelayMs"" INTEGER NOT NULL DEFAULT 0,
                    ""FakeResponseTemplate"" TEXT NULL,
                    ""IsEnabled"" INTEGER NOT NULL DEFAULT 1,
                    ""CreatedAt"" TEXT NOT NULL DEFAULT '2025-01-01 00:00:00'
                );"),
            ("BackupSettings", @"
                CREATE TABLE IF NOT EXISTS ""BackupSettings"" (
                    ""Id"" INTEGER NOT NULL CONSTRAINT ""PK_BackupSettings"" PRIMARY KEY,
                    ""AutoBackupEnabled"" INTEGER NOT NULL DEFAULT 1,
                    ""BackupIntervalHours"" INTEGER NOT NULL DEFAULT 12,
                    ""NotificationEmail"" TEXT NULL DEFAULT 'hoquangtruongctld4@gmail.com',
                    ""LastBackupUtc"" TEXT NULL,
        ...
        var columnsToAdd = new List<(string TableName, string ColumnName, string ColumnDefinition)>
        {
            ...
            ("Users", "VbeeCharacterLimit", "INTEGER NOT NULL DEFAULT 0"),
            ("Users", "VbeeCharactersUsed", "INTEGER NOT NULL DEFAULT 0"),
            ("Users", "LastVbeeResetUtc", "TEXT NOT NULL DEFAULT '0001-01-01 00:00:00'"),
            ("Users", "VbeeResetMonthly", "INTEGER NOT NULL DEFAULT 0"),
            ("Users", "VbeeQuotaStartedAt", "TEXT NULL"),
            ("TierDefaultSettings", "DailyVipSrtLimit", "INTEGER NOT NULL DEFAULT 0"),
            ("TierDefaultSettings", "VbeeCharacterLimit", "INTEGER NOT NULL DEFAULT 0"),
            ("TierDefaultSettings", "VbeeResetMonthly", "INTEGER NOT NULL DEFAULT 0"),
            ("VipTranslationSettings", "MaxSrtLineLength", "INTEGER NOT NULL DEFAULT 3000"),
            ("SubtitleApiSettings", "RpmPeriodSeconds", "INTEGER NOT NULL DEFAULT 60"),
            // === Proxy Latency Columns ===
            ("Proxies", "LatencyMs", "INTEGER NULL"),
