...
namespace SubPhim.Server.Controllers
{
    ...
    public class AppUpdateController : ControllerBase
    {
        ...
        public record UpdateCheckResponse(
            ...
            string DownloadUrl, 
            string ReleaseNotes,
            bool ForceUpdate // Nếu true, client sẽ tự động cập nhật khi ở homepage
        );
