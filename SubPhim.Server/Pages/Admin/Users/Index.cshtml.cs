...
namespace SubPhim.Server.Pages.Admin.Users
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetTierDefaultsAsync(SubscriptionTier tier, bool? isPro = null)
        {
            ...
            return new JsonResult(new
            {
                ...
                settings.VbeeCharacterLimit,
                settings.VbeeResetMonthly,
                // === KẾT THÚC THÊM MỚI ===
                AllowedApis = apis,
        ...
        private async Task PaginateQuery(IQueryable<User> query)
        {
            ...
            var userViewModels = usersForCurrentPage.Select(u =>
            {
                ...
                return new UserViewModel
                {
                    ...
                    VbeeCharactersUsed = u.VbeeCharactersUsed,
                    VbeeCharacterLimit = u.VbeeCharacterLimit,
                    VbeeResetMonthly = u.VbeeResetMonthly
                    // === KẾT THÚC THÊM MỚI ===
                };
            }).ToList();
        ...
        public async Task<IActionResult> OnPostUpdatePermissionsAsync([FromForm] UpdatePermissionsRequest request)
        {
            ...
            // Vbee TTS quota
            userInDb.VbeeCharacterLimit = request.VbeeCharacterLimit;
            userInDb.VbeeResetMonthly = request.VbeeResetMonthly;
            if (request.VbeeResetMonthly && userInDb.VbeeQuotaStartedAt == null)
            {
                userInDb.VbeeQuotaStartedAt = DateTime.UtcNow;
            }
            else if (!request.VbeeResetMonthly)
            {
                userInDb.VbeeQuotaStartedAt = null;
            }
            // === KẾT THÚC THÊM MỚI ===
    ...
    public class UpdatePermissionsRequest
    {
        ...
        public bool VbeeResetMonthly { get; set; }
        // === KẾT THÚC THÊM MỚI ===
    }
    ...
    public class UserViewModel
    {
        ...
        public int DailyVipSrtLimit { get; set; }
        public long VbeeCharactersUsed { get; set; }
        public long VbeeCharacterLimit { get; set; }
        public bool VbeeResetMonthly { get; set; }
        // === KẾT THÚC THÊM MỚI ===
    }
