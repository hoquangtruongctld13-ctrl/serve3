                ...
                if (setting.Tier == SubscriptionTier.Yearly)
                {
                    ...
                    if (!Configs.ContainsKey(setting.Tier) || setting.IsYearlyProSettings)
                    {
                        ...
                        Configs.Add(setting.Tier, new TierConfigModel
                        {
                            ...
                            VbeeCharacterLimit = setting.VbeeCharacterLimit,
                            VbeeResetMonthly = setting.VbeeResetMonthly
                        });
                    }
                }
            ...
            try
            {
                foreach (var configEntry in Configs)
                {
                    ...
                    if (settingInDb != null)
                    {
                        ...
                        settingInDb.VbeeCharacterLimit = formConfig.VbeeCharacterLimit;
                        settingInDb.VbeeResetMonthly = formConfig.VbeeResetMonthly;
                    }
                    else
                    {
                        ...
                        _context.TierDefaultSettings.Add(new TierDefaultSetting
                        {
                            ...
                            VbeeCharacterLimit = formConfig.VbeeCharacterLimit,
                            VbeeResetMonthly = formConfig.VbeeResetMonthly
                        });
                    }
                }
        ...
        public async Task<IActionResult> OnPostApplyToAllUsersAsync(SubscriptionTier tier)
        {
            ...
            try
            {
                ...
                foreach (var user in usersToUpdate)
                {
                    ...
                    // Vbee TTS
                    user.VbeeCharacterLimit = configToApply.VbeeCharacterLimit;
                    user.VbeeResetMonthly = configToApply.VbeeResetMonthly;
                    if (configToApply.VbeeResetMonthly && user.VbeeQuotaStartedAt == null)
                    {
