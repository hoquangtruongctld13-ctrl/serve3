    ...
    public class EmailService : IEmailService
    {
        ...
        public async Task SendEmailAsync(string toEmail, string subject, string body)
        {
            try
            {
                ...
                message.From.Add(new MailboxAddress("SubPhim Server", _smtpSettings.Username));
            ...
            string attachmentMimeType = "application/octet-stream")
        {
            try
            {
                ...
                _logger.LogInformation("Email with attachment '{AttachmentName}' sent successfully to {Email}", 
                    attachmentFileName, toEmail);
            }
            catch (Exception ex)
            {
