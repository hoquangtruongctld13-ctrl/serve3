...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SubPhim.Server.Data.AioTranslationSetting", b =>
                {
                    ...
                    b.Property<int>("RpdPerProxy")
                        .HasColumnType("INTEGER");

                    b.Property<int>("RpmPerKey")
                        .HasColumnType("INTEGER");

                    b.Property<int>("RpmPerProxy")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SubPhim.Server.Data.AioTtsServiceAccount", b =>
                {
                    ...
                    b.HasIndex("ClientEmail", "ModelType")
                        .IsUnique();
            ...
            modelBuilder.Entity("SubPhim.Server.Data.ExternalApiCreditTransaction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<long?>("RelatedUsageLogId")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("ExternalApiCreditTransactions");
                });

            modelBuilder.Entity("SubPhim.Server.Data.ExternalApiKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<long>("TotalCreditsAdded")
                        .HasColumnType("INTEGER");

                    b.Property<long>("TotalCreditsUsed")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SubPhim.Server.Data.ExternalApiSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("CreditsPerCharacter")
                        .HasColumnType("INTEGER");

                    b.Property<long>("DefaultInitialCredits")
                        .HasColumnType("INTEGER");

                    b.Property<int>("DefaultRpm")
                        .HasColumnType("INTEGER");

                    b.Property<DateTime>("UpdatedAt")
                        .HasColumnType("TEXT");

                    b.Property<decimal>("VndPerCredit")
            ...
            modelBuilder.Entity("SubPhim.Server.Data.ExternalApiUsageLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<long>("CreditsCharged")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("GeminiErrors")
                        .HasColumnType("TEXT");

                    b.Property<int>("InputLines")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("ExternalApiUsageLogs");
                });
            ...
            modelBuilder.Entity("SubPhim.Server.Data.ManagedApiKey", b =>
                {
                    ...
                    b.Property<int>("Consecutive429Count")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<DateTime?>("TemporaryCooldownUntil")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("SubPhim.Server.Data.Proxy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("AioRequestsToday")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SubPhim.Server.Data.SubtitleApiKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<long>("TotalFailedRequests")
                        .HasColumnType("INTEGER");

                    b.Property<long>("TotalSuccessRequests")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("SubtitleApiKeys");
                });

            modelBuilder.Entity("SubPhim.Server.Data.SubtitleApiSetting", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("INTEGER");

                    b.Property<int>("ApiKeyCooldownMinutes")
                        .HasColumnType("INTEGER");

                    b.Property<int>("ApiKeysPerServer")
                        .HasColumnType("INTEGER");

                    b.Property<int>("BatchSizePerServer")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("DelayBetweenServerBatchesMs")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("EnableCallback")
                        .HasColumnType("INTEGER");

                    b.Property<int>("LinesPerServer")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("MaxServerRetries")
                        .HasColumnType("INTEGER");

                    b.Property<int>("MergeBatchThreshold")
                        .HasColumnType("INTEGER");

                    b.Property<int>("ServerTimeoutSeconds")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("RpmPeriodSeconds")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SubPhim.Server.Data.SubtitleServerTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("SubtitleServerTasks");
                });

            modelBuilder.Entity("SubPhim.Server.Data.SubtitleTranslationJob", b =>
                {
                    b.Property<string>("SessionId")
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");

                    b.Property<string>("ApiKeyUsageJson")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("ExternalApiKeyPrefix")
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("SubtitleTranslationJobs");
                });

            modelBuilder.Entity("SubPhim.Server.Data.SubtitleTranslationServer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("SubtitleTranslationServers");
                });
            ...
            modelBuilder.Entity("SubPhim.Server.Data.TierDefaultSetting", b =>
                {
                    ...
                    b.Property<int>("DailyVipSrtLimit")
                        .HasColumnType("INTEGER");

                    b.Property<int>("GrantedFeatures")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("IsYearlyProSettings")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("Tier", "IsYearlyProSettings")
                        .IsUnique();
            ...
            modelBuilder.Entity("SubPhim.Server.Data.User", b =>
                {
                    ...
                    b.Property<DateTime>("LastVipSrtResetUtc")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int>("VipSrtLinesUsedToday")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SubPhim.Server.Data.VipApiKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("VipApiKeys");
                });

            modelBuilder.Entity("SubPhim.Server.Data.VipAvailableApiModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("VipAvailableApiModels");
                });

            modelBuilder.Entity("SubPhim.Server.Data.VipTranslationSetting", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("MaxSrtLineLength")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("VipTranslationSettings");
                });
            ...
            modelBuilder.Entity("SubPhim.Server.Data.ExternalApiCreditTransaction", b =>
                {
                    b.HasOne("SubPhim.Server.Data.ExternalApiKey", "ApiKey")
            ...
            modelBuilder.Entity("SubPhim.Server.Data.SubtitleServerTask", b =>
                {
                    b.HasOne("SubPhim.Server.Data.SubtitleTranslationServer", "Server")
                        .WithMany()
                        .HasForeignKey("ServerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SubPhim.Server.Data.SubtitleTranslationJob", "Job")
